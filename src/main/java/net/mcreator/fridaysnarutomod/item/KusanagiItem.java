...
import net.mcreator.fridaysnarutomod.procedures.KusanagiRightclickedProcedure;
...
public class KusanagiItem extends SwordItem {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		KusanagiRightclickedProcedure.execute(entity);
		return ar;
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Notorious blade of Sasuke uchiha(right click to cast a genjutsu)"));
	}
}
